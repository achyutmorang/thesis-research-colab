...
| `risk-uq-suite` | `miscalibration_interpretation_colab.ipynb` | [GitHub](experiments/risk-uq-suite/notebooks/miscalibration_interpretation_colab.ipynb) | [Open in Colab](https://colab.research.google.com/github/achyutmorang/waymax-simulation-experiments/blob/main/experiments/risk-uq-suite/notebooks/miscalibration_interpretation_colab.ipynb) | Do saved probe artifacts provide conclusive evidence for miscalibration and budget decision errors? | Load persisted probe outputs, compare raw vs calibrated diagnostics, and emit claim-level verdicts. |
